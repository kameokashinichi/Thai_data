...
"""
written by clement
the format generation(https://dackdive.hateblo.jp/entry/2014/11/15/001318)
    03d -> integer (if "%03d"%(1)->001)
    6.1f -> one decimal point with 6 digit(if "%6.1f"%(19.4)->   19.4)
"""

def dataframe2wtd(df, out_name, add_tave=True, to_slice=False, to_check=True, out_extension = ".WTD"):
