...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 10 15:59:47 2019
...
http://ec2-52-196-202-21.ap-northeast-1.compute.amazonaws.com/cropsim/exec/2019-01-10T06-46-11-056Zf734d1b17737d52e/
soilid -> "JP_NRPH10F"
...
soilW = []
with open(os.getcwd() + '/2019-01-10T06-46-11-056Zf734d1b17737d52e/SoilWat.OUT', 'r') as f:
    for row in f:
...
sw_df7 = pd.DataFrame(s_stress[:, 1:], columns=columns[1:], index = newcol)
 
"""
190108 Summary.OUT
"""
record = []
with open(os.getcwd() + '/2019-01-10T06-46-11-056Zf734d1b17737d52e/Summary.OUT', 'r') as f:
    for row in f:
...
sum_df7 = pd.DataFrame(summary[:, 1:], index=summary[:, 0], columns=col[1:])

"""
190108 SoilNi.OUT read Soil N Dssat file.
"""
soilN = []
with open(os.getcwd() + '/2019-01-10T06-46-11-056Zf734d1b17737d52e/SoilNi.OUT', 'r') as f:
    for row in f:
...
sn_df7 = pd.DataFrame(sn_stress[:, 1:], columns=columns[1:], index = newcol) 
...
PN = []
with open(os.getcwd() + '/2019-01-10T06-46-11-056Zf734d1b17737d52e/PlantN.OUT', 'r') as f:
    for row in f:
        PN.append(row.strip())
...
pn_df7 = pd.DataFrame(pn_stress[:, 1:], columns=columns[1:], index = newcol)
...
PG = []
with open(os.getcwd() + '/2019-01-10T06-46-11-056Zf734d1b17737d52e/PlantGro.OUT', 'r') as f:
    for row in f:
        PG.append(row.strip())
...
pg_df7 = pd.DataFrame(pg_stress[:, 1:].astype(np.float32), columns=columns[1:], index = newcol)
