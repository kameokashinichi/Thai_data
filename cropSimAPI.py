...
def upload_weather_file(weather_zip):
    ...
    url = "http://ec2-52-196-202-21.ap-northeast-1.compute.amazonaws.com/cropsim/v1.1/uploads"
...
def generateCropScenario(transplant_date, weather_id, folder, lat=35.706179, lon=140.482362):
    """
